...
ALLOWED_HOSTS = ['crm1-kyrios.herokuapp.com', 'localhost']
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, '../django-tutorial/static')]
...
# AWS_STORAGE_BUCKET_NAME = 'kyrios-crmi1-bucket'
